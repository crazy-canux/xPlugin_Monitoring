# -*- coding: utf-8 -*-
#
# plugin-app-pdm documentation build configuration file, created by
...
htmlhelp_basename = 'plugin-app-pdmdoc'
...
latex_documents = [
  ('index', 'plugin-app-pdm.tex', u'plugin-app-pdm Documentation',
